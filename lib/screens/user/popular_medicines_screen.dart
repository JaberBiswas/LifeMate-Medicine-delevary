...
class PopularMedicinesScreen extends StatelessWidget {
  const PopularMedicinesScreen({super.key});
      ...
      body: SafeArea(
        child: Consumer<ProductProvider>(
          builder: (context, provider, child) {
            ...
            // Sort by rating and review count (popular = high rating + high reviews)
            List<MedicineModel> popular = List<MedicineModel>.from(medicines)
              ..sort((a, b) {
                final ar = a.rating ?? 0;
                final br = b.rating ?? 0;
