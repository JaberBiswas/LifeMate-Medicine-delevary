      ...
      body: SafeArea(
        child: Consumer<ProductProvider>(
          builder: (context, provider, child) {
            ...
            // Sort by review count (proxy for sales) and rating
            List<MedicineModel> bestSelling = List<MedicineModel>.from(medicines)
              ..sort((a, b) {
            ...
            return Column(
              children: [
                ...
                _buildHeader(bestSelling.length),
                Expanded(
                  child: bestSelling.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final medicine = bestSelling[index];
                            return MedicineCard(
                              medicine: medicine,
                              onTap: () {
                                Navigator.push(
